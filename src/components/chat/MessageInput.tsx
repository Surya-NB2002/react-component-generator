    ...
    <form onSubmit={handleSubmit} className="relative p-4 bg-card border-t border-border/60">
      <div className="relative max-w-4xl mx-auto">
        <textarea
          ...
          disabled={isLoading}
          className="w-full min-h-[80px] max-h-[200px] pl-4 pr-14 py-3.5 rounded-xl border border-border bg-secondary/40 text-foreground resize-none focus:outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary/50 focus:bg-card transition-all placeholder:text-muted-foreground text-[15px] font-normal shadow-sm"
          rows={3}
        />
        <button
          type="submit"
